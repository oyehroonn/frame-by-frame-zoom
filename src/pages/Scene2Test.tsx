...
const Scene2Test = () => {
  ...
  useEffect(() => {
    const loadImages = async () => {
      ...
      console.log(`\n========== SCENE 2 TEST: STARTING FRAME LOAD ==========`);
      ...
      for (let batch = 0; batch < Math.ceil(TOTAL_FRAMES / BATCH_SIZE); batch++) {
        ...
        for (let i = startIdx; i < endIdx; i++) {
          ...
          const promise = new Promise<void>((resolve) => {
            ...
            img.onerror = () => {
              setLoadedCount((prev) => prev + 1);
              console.warn(`Scene2 Test: Failed to load frame${frameNum}.jpg`);
              resolve();
            };
      ...
      console.log(`Scene 2 Test: Loaded ${validImages.length}/${TOTAL_FRAMES} frames`);
    };
